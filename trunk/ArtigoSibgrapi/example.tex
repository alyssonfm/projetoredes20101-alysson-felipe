...
\title{Example of IEEEtran.cls, adapted for Sibgrapi 2011}
...
\teaser{%
  \oneimage{Teasing result of our method: from this data input (left), the relevant feature are extracted using our technique (middle), producing effective result (right).}{.8}{teaser}
}
%------------------------------------------------------------------------- 
...
Approaches in the first category were introduced by Pierre~\cite{sibgrapi2011} using this and that techniques.


\subimages[htb]{Technique overview}{overview}{
  \subimage[First step]{.32}{teaser}%
  \subimage[Second step]{.32}{teaser}%
  \subimage[Result]{.32}{teaser}%
}
%------------------------------------------------------------------------- 
...
%
In this section, we detail this classical technique. The reader can find a more complete exposition in the work of Paul~\cite{sibgrapi2011}.
